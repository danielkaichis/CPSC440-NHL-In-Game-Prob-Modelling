...
from league_monte_carlo import LeagueMonteCarlo
...
if __name__ == "__main__":
    ...
    mc = LeagueMonteCarlo("advi_traces/league_nhl_trace.nc", mapping, home_penalty_share=penalty_share)
    test_data = load_game_data("nhl_raw_data/2025_2026_part2.json")

    scores = evaluate_performance(test_data, mc, DEFAULT_CHECKPOINTS)
    save_path = save_checkpoint_scores(scores, model_name="league")
    print(f"Saved league wide checkpoint results to {save_path}")