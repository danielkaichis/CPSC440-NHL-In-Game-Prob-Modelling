...
from results_store import save_hierarchical_window_results
...
def evaluate_sliding_windows(
    ...
    for i, window_start, window_end, test_window in window_meta:
        ...
        mc = HierarchicalMonteCarlo(
            path, state_map, "h_team_mapping.json",
...
if __name__ == "__main__":
    ...
    save_path = save_hierarchical_window_results(stats_df, model_name="hierarchical")
