...
def plot_saved_results(results_dir=RESULTS_DIR):
    ...
    if checkpoint_files:
        ...
        if not latest_ckpt.empty:
            ...
            plt.title("League vs Team Specific Scoring Rate Model Brier Scores")
            ...
            if "LL" in ckpt.columns:
                ...
                plt.gca().invert_xaxis()
                plt.title("League vs Team Specific Scoring Rate Model Log-Loss")
                plt.xlabel("Minutes Remaining")
                plt.ylabel("Log-Loss")
                plt.grid(alpha=0.3)
                plt.legend()
            ...
            if "ACC" in ckpt.columns:
                ...
                plt.gca().invert_xaxis()
                plt.title("League vs Team Specific Scoring Rate Model Accuracy")
                plt.xlabel("Minutes Remaining")
                plt.ylabel("Accuracy")
                plt.ylim(0, 1)
